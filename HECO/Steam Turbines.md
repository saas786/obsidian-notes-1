...
-	used to minimize friction in main bearing, thrust bearing, and reduction gears
-	lubricates bearing
-	creates an oil wedge that supports the journals
-	keeps temps at a safe operating level
-	supplied to a pump impeller in the main turbine shaft to increase its discharge pressure
...
**Steam Chest** -- a collection area that is designed to distribute the steam to the hydraulically operated turbine control system
...
2.	the thermal energy in the steam is converted to mechanical energy in the turbine
3.	-
4.	-
5.	true
6.	true
...
12.	true
13.	false
14.	all of these (term depends on manufacturer)
15.	false (not turbine blades)
16.	minimize friction in main bearings and thrust bearings; carries away heat; keeps bearing temperatures at safe operating level
17. b
18. false (p.17)

> 19. List at least five (5) uses of the turbine oil system.

-	minimize friction in main bearing
-	minimize friction in thrust bearing
-	carries heat away from turbine
-	supports journal load using oil wedge
-	supplies control oil
-	keeps temperatures at safe operating level

> 20. Give two (2) uses of the turbine throttle valve.

-	controls flow of steam during startup
-	throttle/stop flow of steam