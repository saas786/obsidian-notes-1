...
Before steam is released from the steam drum to the turbines, all the moisture is separated from it in three stages:
...
Systems with only a FDF ==operate at positive pressure==.
