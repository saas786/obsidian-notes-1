...
### De-aerator
Used to remove non-condensible gases from the condensate to minimize corrosion in downstream equipment, while also heating up the condensate.
...
2. 
	-	removes non-condensible gases from the condensate to minimize corrosion
	-	heats up condensate
3.	
	-	