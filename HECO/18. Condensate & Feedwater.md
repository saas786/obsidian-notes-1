...
- provides an area of low pressure for the turbine exhaust (due to the reduction in volume from steam to water)
- used to recycle the steam to use as feedwater in the cycle
