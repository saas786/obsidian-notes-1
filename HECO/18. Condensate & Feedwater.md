...
Used to remove non-condensible gases from the condensor and recovers heat from the ejected air. In the shell side, it takes auxillary steam from the main condensor and discharges it into the atmosphere. It is cooled using condensate in the tube side.
