...
- locally mounted -- devices mounted directly on the line/equipment where tempe
...
A remote mounted dial thermometer (the indicator can be placed some distance away from the point of measurement).
