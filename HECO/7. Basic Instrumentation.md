...
### Pressure Gauge
Measures the difference between atmospheric pressure and pressure within a pipe or vessel (psig).
...
-	**transducer** -- transmit measurements (temperature, pressure, flow, or position) to a remote location (control room)
