...
-	units:
	-	Fahrenheit (normally used scale)
	-	Centigrade (==used to measure temps of electrical equipment==)
...
## Switches
Used to open or close an electrical switch based on some measured value from a sensor. This can be ==used to start an alarm or to start/stop equipment==.
