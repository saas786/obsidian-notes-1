...
-	Condensate (from fuel oil heaters) in the shell side

The steam generated in a reboiler is used to heat fuel oil in the [[Fuel Oil System]] to the correct temperature and viscosity for burner gun firing.

## Other Heat Exchangers
-	[[Condensate & Feedwater System#Air Ejector Condensers|air ejector condenser]]
-	[[Circulating Water System#Chillers|chillers]] -- cools aux cooling water
...
>1. The term heat exchanger can be applied to any piece of equipment designed to ________ .

transfer heat

>2. Feedwater heaters raise the temperature by the use of steam extracted from the turbine or reheat piping. True\ False

true

>3. In open or contact heaters, extraction steam and feedwater are mixed, while in closed heaters, no mixing occurs. True \ False

true

>4. Open heaters are designed to ________ (remove dissolved gases) from the feedwater.

de-aerate

>5. At the saturation temperature, water cannot retain gases in solution. True \ False

true

>6. The most effective heater has the lowest terminal temperature difference and transfers heat with the smallest temperature difference. True \ False

true

>7. The closed heater contains which of the following features?
>a. U-tubes
>b. Drain outlet
>c. Water box
>d. All of the above 
...
>8. Open heaters are more economical than closed heaters because each heater does not have to be followed by a pump to prevent the feedwater from flashing. True \ False

false

>9. The effectiveness of a closed heater is affected by what is done with the drains leaving the heater. True \ False

true

>10. Briefly explain the cascading drain system.

as the condensate drains down to the next heater, it will flash into saturated steam, which helps to heat the feedwater

>11. The cascading drain system always has to include one open heater that automatically stops the cascade. True \ False

false

>12. Why is each heater provided with an alternate drain disposal route, and where is this route usually directed?

-	for safety & maintenance
-	directed to the condenser

>13. To prevent thermal or hydraulic shock in feedwater heaters during startup, the extraction steam should be supplied to the heater to warm it up before the water begins to flow through the tubes. True \ False

false

>14. List the two (2) major functions common to all condensers.

1.	creates an area of low pressure for the LP turbine
2.	reclaims pure condensate for reuse in the system

>15. The condenser is a shell and tube heat exchanger. True \ False

true

>16. The condenser is usually located ________ .
>a. directly after the main feed pump.
>b. directly below the turbine exhaust.
>c. as close as possible to the boiler. 
>d. None of the above.

directly below the turbine exhaust

>17. Why is the water side of a condenser divided into two separate halves?

to be able to clean one half while the other half is in service

>18. How are non-condensable gases able to enter the condenser?

with steam and leakage

>19. Describe the main components of the plate heat exchanger.

![[8. Heat Exchangers#^plate-heat-exchanger-components]]

>20. How is the heat exchange accomplished in a plate heat exchanger?

conduction

>21. Name at least two (2) features of a plate heat exchanger that are not found in a shell and tube heat exchanger.

-	size contraints
-	ability to change heat transfer capacity
